...
CHILDHOOD = [
    "Детство прошло в небольшом городке, часто гулял во дворе.",
    "С ранних лет увлекался техникой, помогал отцу в гараже.",
    "Любил читать книги и играть в шахматы с бабушкой.",
    "С детства увлекался спортом, участвовал в соревнованиях.",
    "Рос в семье военных, часто переезжал."
]
ADULTHOOD = [
    "Закончил университет, начал работать по специальности.",
    "Переехал в крупный город, устроился на престижную работу.",
    "Открыл свой бизнес и создал крепкую семью.",
    "Работал в разных компаниях, набирался опыта.",
    "Достиг успеха в выбранной профессии."
]
NOW = [
    "Работает в крупной компании и развивает свои навыки.",
    "Занимается любимым делом и помогает друзьям.",
    "Женат, двое детей, мечтает о путешествиях по миру.",
    "Строит дом за городом, выращивает сад.",
    "Планирует открыть собственное дело."
]
